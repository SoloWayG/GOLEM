...
from golem_examples.molecule_search.mol_transformer.transformer import create_masks, Transformer, EXTRA_CHARS, ALPHABET_SIZE
from golem_examples.molecule_search.utils import download_from_github
